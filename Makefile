...
DIST_COMMON = INSTALL NEWS README AUTHORS ChangeLog \
	...
	$(dist_doc_DATA) $(dist_m4_DATA) COPYING config.guess \
...
ACLOCAL = ${SHELL} /usr/src/pkg-config/pkg-config/missing aclocal-1.13
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = ar
AUTOCONF = ${SHELL} /usr/src/pkg-config/pkg-config/missing autoconf
AUTOHEADER = ${SHELL} /usr/src/pkg-config/pkg-config/missing autoheader
AUTOMAKE = ${SHELL} /usr/src/pkg-config/pkg-config/missing automake-1.13
AWK = gawk
CC = gcc
...
LN_S = ln -s
LTLIBOBJS = 
MAKEINFO = ${SHELL} /usr/src/pkg-config/pkg-config/missing makeinfo
MANIFEST_TOOL = :
...
SHELL = /bin/sh
STRIP = strip
TESTS_SHELL = /usr/bin/bash
VERSION = 0.28
WARN_CFLAGS = -g -Wall -O2
abs_builddir = /usr/src/pkg-config/pkg-config
abs_srcdir = /usr/src/pkg-config/pkg-config
abs_top_builddir = /usr/src/pkg-config/pkg-config
abs_top_srcdir = /usr/src/pkg-config/pkg-config
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_DUMPBIN = 
am__include = include
...
install_sh = ${SHELL} /usr/src/pkg-config/pkg-config/install-sh
